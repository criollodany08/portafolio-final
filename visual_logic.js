...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectByName, bindListener, getObjectName, getObjectUUID,
...
eventHTMLElem('click', 'boton', false, function(event) {
    tweenCamera('cam 01', 'perspectiva', 1, function() {}, 0);
});

registerOnClick('plano 01', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 01', 'plano 01', 1, function() {}, 0);
}, function(event) {});

registerOnClick('plano 02', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 02', 'plano 02', 1, function() {}, 0);
}, function(event) {});

registerOnClick('plano 03', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 03', 'plano 03', 1, function() {}, 0);
}, function(event) {});

registerOnClick('planos 04', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 04', 'planos 04', 1, function() {}, 0);
}, function(event) {});

registerOnClick('plano 05', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 05', 'plano 05', 1, function() {}, 0);
}, function(event) {});

registerOnClick('monitor', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty', 'perspectiva 002', 1, function() {}, 0);
}, function(event) {});
